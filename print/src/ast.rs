...
//print_struct!(ClassDef<'_>, self, self.loc, ClassDef, self.name self.abstract_ self.parent self.field);
        ...
        match self {
            ...
            FieldDef::FuncDef(f) => {
                ...
                p.indent(|p| {
                    ...
                    debug_assert!(!(f.static_ && f.abstract_), "both static and abstract!!");
                    f.name.print(p);
                    f.ret.print(p);
                    f.param.print(p);
                    f.body.print(p);
